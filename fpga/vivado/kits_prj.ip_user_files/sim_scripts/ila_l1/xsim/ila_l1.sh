...
#
# Script generated by Vivado on Wed Dec 04 09:01:42 +0800 2024
...
#
# Usage        : ila_l1.sh
#                ila_l1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_l1.sh [-reset_run]
#                ila_l1.sh [-reset_log]
#                ila_l1.sh [-help]
#
...
# script info
echo -e "ila_l1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_l1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_l1 xil_defaultlib.ila_l1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_l1 -key {Behavioral:sim_1:Functional:ila_l1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_l1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_l1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_l1.sh [-help]\n\
Usage: ila_l1.sh [-step]\n\
Usage: ila_l1.sh [-lib_map_path]\n\
Usage: ila_l1.sh [-reset_run]\n\
Usage: ila_l1.sh [-reset_log]\n\
Usage: ila_l1.sh [-keep_index]\n\
Usage: ila_l1.sh [-noclean_files]\n\n\

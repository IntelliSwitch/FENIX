...
#
# Script generated by Vivado on Wed Dec 04 09:02:10 +0800 2024
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : vio_addr.sh
...
#
# Usage        : vio_addr.sh
#                vio_addr.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_addr.sh [-reset_run]
#                vio_addr.sh [-reset_log]
#                vio_addr.sh [-help]
#
...
# script info
echo -e "vio_addr.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_addr.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vio_addr xil_defaultlib.vio_addr xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vio_addr -key {Behavioral:sim_1:Functional:vio_addr} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vio_addr.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_addr.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_addr.sh [-help]\n\
Usage: vio_addr.sh [-step]\n\
Usage: vio_addr.sh [-lib_map_path]\n\
Usage: vio_addr.sh [-reset_run]\n\
Usage: vio_addr.sh [-reset_log]\n\
Usage: vio_addr.sh [-keep_index]\n\
Usage: vio_addr.sh [-noclean_files]\n\n\

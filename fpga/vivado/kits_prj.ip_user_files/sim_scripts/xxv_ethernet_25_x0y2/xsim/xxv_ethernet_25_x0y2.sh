...
#
# Script generated by Vivado on Sun Dec 08 03:34:16 +0800 2024
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : xxv_ethernet_25_x0y2.sh
...
#
# Usage        : xxv_ethernet_25_x0y2.sh
#                xxv_ethernet_25_x0y2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xxv_ethernet_25_x0y2.sh [-reset_run]
#                xxv_ethernet_25_x0y2.sh [-reset_log]
#                xxv_ethernet_25_x0y2.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L xxv_ethernet_v4_1_13"

# script info
echo -e "xxv_ethernet_25_x0y2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xxv_ethernet_25_x0y2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L gtwizard_ultrascale_v1_7_19 -L xxv_ethernet_v4_1_13 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xxv_ethernet_25_x0y2 xil_defaultlib.xxv_ethernet_25_x0y2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xxv_ethernet_25_x0y2 -key {Behavioral:sim_1:Functional:xxv_ethernet_25_x0y2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xxv_ethernet_25_x0y2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xxv_ethernet_25_x0y2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xxv_ethernet_25_x0y2.sh [-help]\n\
Usage: xxv_ethernet_25_x0y2.sh [-step]\n\
Usage: xxv_ethernet_25_x0y2.sh [-lib_map_path]\n\
Usage: xxv_ethernet_25_x0y2.sh [-reset_run]\n\
Usage: xxv_ethernet_25_x0y2.sh [-reset_log]\n\
Usage: xxv_ethernet_25_x0y2.sh [-keep_index]\n\
Usage: xxv_ethernet_25_x0y2.sh [-noclean_files]\n\n\

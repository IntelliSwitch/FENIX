...
#
# Script generated by Vivado on Fri Aug 01 07:33:35 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : CNN_stream_0.sh
...
#
# Usage        : CNN_stream_0.sh
#                CNN_stream_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CNN_stream_0.sh [-reset_run]
#                CNN_stream_0.sh [-reset_log]
#                CNN_stream_0.sh [-help]
#
...
# script info
echo -e "CNN_stream_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CNN_stream_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CNN_stream_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CNN_stream_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CNN_stream_0.sh [-help]\n\
Usage: CNN_stream_0.sh [-step]\n\
Usage: CNN_stream_0.sh [-lib_map_path]\n\
Usage: CNN_stream_0.sh [-reset_run]\n\
Usage: CNN_stream_0.sh [-reset_log]\n\
Usage: CNN_stream_0.sh [-keep_index]\n\
Usage: CNN_stream_0.sh [-noclean_files]\n\n\

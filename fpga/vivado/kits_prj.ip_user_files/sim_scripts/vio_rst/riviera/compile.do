...
vlog -work xpm  -incr -l xxv_ethernet_v4_1_13 "+incdir+../../../ip/vio_rst/hdl/verilog" "+incdir+../../../ip/vio_rst/hdl" "+incdir+D:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../ip/vio_rst/hdl/verilog" "+incdir+../../../ip/vio_rst/hdl" "+incdir+D:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
"../../../ip/vio_rst/sim/vio_rst.v" \

...
#
# Script generated by Vivado on Wed Dec 04 08:58:27 +0800 2024
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_axis_data_1024.sh
...
#
# Usage        : fifo_axis_data_1024.sh
#                fifo_axis_data_1024.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_axis_data_1024.sh [-reset_run]
#                fifo_axis_data_1024.sh [-reset_log]
#                fifo_axis_data_1024.sh [-help]
#
...
# script info
echo -e "fifo_axis_data_1024.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_axis_data_1024.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_axis_data_1024 xil_defaultlib.fifo_axis_data_1024 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_axis_data_1024 -key {Behavioral:sim_1:Functional:fifo_axis_data_1024} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_axis_data_1024.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_axis_data_1024.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_axis_data_1024.sh [-help]\n\
Usage: fifo_axis_data_1024.sh [-step]\n\
Usage: fifo_axis_data_1024.sh [-lib_map_path]\n\
Usage: fifo_axis_data_1024.sh [-reset_run]\n\
Usage: fifo_axis_data_1024.sh [-reset_log]\n\
Usage: fifo_axis_data_1024.sh [-keep_index]\n\
Usage: fifo_axis_data_1024.sh [-noclean_files]\n\n\

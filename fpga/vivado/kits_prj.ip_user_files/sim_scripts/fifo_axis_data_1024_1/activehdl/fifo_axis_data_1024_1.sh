...
#                script (type 'fifo_axis_data_1024_1.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/sidejob/ethernet_NN/kitsum_1024B_xy_20231211/kits_prj.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then

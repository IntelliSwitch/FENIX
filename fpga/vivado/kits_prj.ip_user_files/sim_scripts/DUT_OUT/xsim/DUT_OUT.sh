...
#
# Script generated by Vivado on Sat Jul 26 23:16:48 +0800 2025
...
#
# Usage        : DUT_OUT.sh
#                DUT_OUT.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DUT_OUT.sh [-reset_run]
#                DUT_OUT.sh [-reset_log]
#                DUT_OUT.sh [-help]
#
...
# script info
echo -e "DUT_OUT.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DUT_OUT.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L gtwizard_ultrascale_v1_7_19 -L xxv_ethernet_v4_1_13 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DUT_OUT xil_defaultlib.DUT_OUT xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DUT_OUT -key {Behavioral:sim_1:Functional:DUT_OUT} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DUT_OUT.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DUT_OUT.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DUT_OUT.sh [-help]\n\
Usage: DUT_OUT.sh [-step]\n\
Usage: DUT_OUT.sh [-lib_map_path]\n\
Usage: DUT_OUT.sh [-reset_run]\n\
Usage: DUT_OUT.sh [-reset_log]\n\
Usage: DUT_OUT.sh [-keep_index]\n\
Usage: DUT_OUT.sh [-noclean_files]\n\n\

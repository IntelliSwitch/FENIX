...
vlog -work xpm  -incr -l xxv_ethernet_v4_1_13 "+incdir+../../../ip/ila_muit_addr_data/hdl/verilog" "+incdir+D:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../ip/ila_muit_addr_data/hdl/verilog" "+incdir+D:/Xilinx/Vivado/2024.2/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
"../../../ip/ila_muit_addr_data/sim/ila_muit_addr_data.v" \

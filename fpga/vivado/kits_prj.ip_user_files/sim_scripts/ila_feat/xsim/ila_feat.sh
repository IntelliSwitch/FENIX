...
#
# Script generated by Vivado on Wed Dec 04 09:00:56 +0800 2024
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_feat.sh
...
#
# Usage        : ila_feat.sh
#                ila_feat.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_feat.sh [-reset_run]
#                ila_feat.sh [-reset_log]
#                ila_feat.sh [-help]
#
...
# script info
echo -e "ila_feat.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_feat.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_feat xil_defaultlib.ila_feat xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_feat -key {Behavioral:sim_1:Functional:ila_feat} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_feat.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_feat.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_feat.sh [-help]\n\
Usage: ila_feat.sh [-step]\n\
Usage: ila_feat.sh [-lib_map_path]\n\
Usage: ila_feat.sh [-reset_run]\n\
Usage: ila_feat.sh [-reset_log]\n\
Usage: ila_feat.sh [-keep_index]\n\
Usage: ila_feat.sh [-noclean_files]\n\n\

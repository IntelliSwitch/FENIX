...
HD_PWD='D:/sidejob/kitsum_1024B_xy_20231211/kits_prj.runs/fifo_gen_axis1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_gen_axis1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_gen_axis1024.tcl

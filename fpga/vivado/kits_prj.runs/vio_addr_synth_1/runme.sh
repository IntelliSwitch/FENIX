...
HD_PWD='D:/sidejob/kitsum_1024B_xy_20231211/kits_prj.runs/vio_addr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_addr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_addr.tcl

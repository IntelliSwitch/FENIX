...
HD_PWD='D:/sidejob/ethernet_NN/kitsum_1024B_xy_20231211/kits_prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kits_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kits_top.tcl

...
HD_PWD='D:/sidejob/ethernet_NN/kitsum_1024B_xy_20231211/kits_prj.runs/CNN_stream_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CNN_stream_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CNN_stream_0.tcl

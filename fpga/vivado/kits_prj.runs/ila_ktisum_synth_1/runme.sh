...
HD_PWD='D:/sidejob/kitsum_1024B_xy_20231211/kits_prj.runs/ila_ktisum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_ktisum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_ktisum.tcl

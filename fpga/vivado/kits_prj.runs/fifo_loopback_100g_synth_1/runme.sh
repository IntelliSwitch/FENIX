...
HD_PWD='D:/sidejob/ethernet_NN/kitsum_1024B_xy_20231211/kits_prj.runs/fifo_loopback_100g_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_loopback_100g.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_loopback_100g.tcl

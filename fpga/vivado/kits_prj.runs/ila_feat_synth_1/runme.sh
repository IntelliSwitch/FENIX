...
HD_PWD='D:/sidejob/kitsum_1024B_xy_20231211/kits_prj.runs/ila_feat_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_feat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_feat.tcl

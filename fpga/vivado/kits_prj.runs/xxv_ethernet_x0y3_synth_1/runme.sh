...
HD_PWD='D:/sidejob/ethernet_NN/kitsum_1024B_xy_20231211/kits_prj.runs/xxv_ethernet_x0y3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xxv_ethernet_x0y3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xxv_ethernet_x0y3.tcl

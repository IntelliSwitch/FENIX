...
HD_PWD='D:/sidejob/kitsum_1024B_xy_20231211/kits_prj.runs/ila_axis_64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_axis_64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_axis_64.tcl

...
DEFAULT_MODEL_ROOT = './checkpoint/cnn'
DEFAULT_QUANT_OUTPUT_ROOT = './quantization_output/cnn'
DEFAULT_LOG_DIR = './log/quantize/cnn'
...
def main():
    parser = argparse.ArgumentParser(
        description='Quantize TextCNN1 model using Vitis AI (Parameters are mostly predefined)',

...
class TextCNN1(py_nndct.nn.NndctQuantModel):
    def __init__(self):
        ...
        self.module_32 = py_nndct.nn.Linear(in_features=72, out_features=12, bias=True) #TextCNN1::TextCNN1/Linear[fc2]/ret.41(TextCNN1::nndct_dense_32)
        ...
        self.module_35 = py_nndct.nn.BatchNorm(num_features=12, eps=0.0, momentum=0.1) #TextCNN1::TextCNN1/BatchNorm1d[bn_logits]/ret.47(TextCNN1::nndct_batch_norm_35)
    ...
    def forward(self, *args):
        ...
        output_module_21 = self.module_33(input=output_module_21, shape=[-1,12])
